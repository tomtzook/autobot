...
void define_value(device_id id, value_key key, const char* name, device_type supported_types, data_type type, data_permission permission, value_capabilities capabilities = value_capabilities::none);
...
void set_value_callback(device_id id, value_key key, callback_value_set&& callback);
